...
ابسیدین برای استفاده شخصی رایگان است و فقط برای استفاده تجاری نیاز به پرداخت هزینه دارد. ابسیدین یک نرم‌افزار فریمیوم است یعنی برخی از قابلیت‌های آن رایگان و برخی دیگر نیاز به تهیه اشتراک و پرداخت هزینه دارد. اکثر امکانات نرم‌افزار رایگان است و فقط یکسری از امکانات غیرضروری آن مثل [«Obsidian Sync»]({{< ref "آشنایی با نرم افزار ابسیدین (obsidian)#همگامسازی-obsidian-sync" >}}) و [«Obsidian Publish»]({{< ref "آشنایی با نرم افزار ابسیدین (obsidian)#انتشار-obsidian-publish" >}}) نیاز به تهیه اشتراک دارد.
